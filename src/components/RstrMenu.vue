  ...
  >
    ...
    <v-tabs-items>
      ...
      >
        ...
        >
          <v-tabs-slider color="yellow"></v-tabs-slider>
          <v-tab
            v-for="date_namsan in dates_namsan"
            :key="date_namsan"
          >
          {{ date_namsan }}
          </v-tab>
    ...
    <v-container fluid grid-list-md>
      <v-data-iterator
        ...
        v-if="date_namsan === dates_namsan[0]"
      ...
      <v-data-iterator
        :items="namsan_tuesday"
        :rows-per-page-items="rowsPerPageItems"
        :pagination.sync="pagination"
        v-else-if="date_namsan === dates_namsan[1]"
        content-tag="v-layout"
        hide-actions
        row
        wrap
...
<!-- 카드 삽입구간 끝 -->
        ...
        >
          <v-tabs-slider color="yellow"></v-tabs-slider>
          <v-tab
            v-for="date_boramae in dates_boramae"
            :key="date_boramae"
          >
          {{ date_boramae }}
          </v-tab>
  ...
  export default {
    data () {
      return {
        ...
        places: ['남산', '보라매'],
        dates_namsan: ['7/29(월)', '7/30(화)', '7/31(수)', '8/1(목)', '8/2(금)'],
        dates_boramae: ['7/29(월)보', '7/30(화)보', '7/31(수)보', '8/1(목)보', '8/2(금)보'],
        namsans: ['namsan_monday', 'namsan_tuesday'],
